...
@section('title', 'Reporte de Préstamos Pendientes')

@section('content_header')
    <h1>Reporte de Préstamos Pendientes</h1>
@stop

@section('content')
    <select id="FiltroActivos" style="visibility:hidden">
    ...
    <div class="row">
        ...
        @endif
        <table id="prestamos" class="table col-12">
            <thead>
                <tr>
                    <th>ID Préstamo</th>
                    <th>Usuario</th>
...
@section('js')
    <script src="https://code.jquery.com/jquery-3.5.1.js"></scr ipt>
